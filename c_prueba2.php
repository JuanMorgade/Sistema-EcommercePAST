...
<header class="row header--sticky">
    ...
    <article>
        ...
        <section class="compra_curso">
            <div class="info_c">
                <h3>CURSO: DE PRUEBA 2</h3>
                <p><em>Curso de Prueba para probar la Pag, Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum ab vitae, sit reprehenderit illum natus labore.</em></p>
                
                <div class="grid__imagen">
                    <div>
                        <img class="imagen_curso" src="./imagen/prueba2.jpg" alt="">
                    </div>
                    <div>
                        <img class="imagen_curso" src="./imagen/prueba3.jpg" alt="">
                    </div>
                    <div>
                        <img class="imagen_curso" src="./imagen/prueba1.jpg" alt="">
                    </div>
                </div>
                <p><u>El Curso Cuenta Con</u> : Un monto bajo para probar la funcionalidad de la pagina y su SDK de Mercado Pago, Receta y video del buttercream de merengue suizo, Videos paso a paso: cómo hornear, rellenar, cubrir y alisar, Receta y paso a paso del efecto drip o goteo, Los mejores rellenos para tus alfajores (guía paso a paso en Zoom).</p>
                <p>Por el modico precio de: $279</p>
