    ...
    <article>
        <section class="row">
            <div class="col-12 mt-5">
                <br><br>
                <h2 class="subtitulo mt-5 text-center">Pedido de Compras</h2>
            </div>
        </section>   
            ...
            <div class="compra_curso">
                ...
                <h3>Datos de Transferencia Bancaria</h3>
                    <div class="p-line"><div>MONTO TOTAL:</div>$<span id="montototal"></span></div>
                        <div class="p-line"><div>Banco:</div>MercadoPago / RedLink</div>
                        <div class="p-line"><div>CVU:</div>003101328040457</div>
                        <div class="p-line"><div>Nombre:</div>Morgade Juan Pablo</div>
                        <br>
                        <div><b>Si va transferir el dinero, porfavor mandar un mensaje a este numero: 1135152345, con el comprobante de pago</b></div>
			...
			$.ajax({
				...
				success:function(data){
                    ...
                    if(data.datos.length==0){
                        Swal.fire({
                                title: "No hay Productos En Lista de Pedido",
                                icon: "error",
                                timer: 2500
                            });
                            setTimeout(() => {
