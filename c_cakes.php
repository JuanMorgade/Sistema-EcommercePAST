    ...
    <article>
        <section class="row">
            <div class="col-12 mt-5">
                <br><br>
                <h2 class="subtitulo mt-5 text-center">Comprar Curso de Tortas</h2>
                <br><br>
            </div>
        </section>
        ...
        <section class="compra_curso">
            <div class="info_c">
                <h3>CURSO: DE CAKES / TORTAS</h3>
                <p><em>Dulce de pasta de harina, huevos, aceite y otros ingredientes, a la que se le puede dar formas y tamaños variados pero suele ser redonda y aplastada, que se cuece a horno moderado</em></p>
                
                <div class="grid__imagen">
                    <div>
                        <img class="imagen_curso" src="./imagen/brownie.jpg" alt="">
                    </div>
                    <div>
                        <img class="imagen_curso" src="./imagen/Imagen_Prueba/cake6.jpg" alt="">
                    </div>
                    <div>
                        <img class="imagen_curso" src="./imagen/Imagen_Prueba/dilyara-garifullina-EGdB-PgeJlw-unsplash.jpg" alt="">
                    </div>
                </div>
                <p><u>El Curso Cuenta Con</u> : Receta y video del bizcochuelo de vainilla, Receta y video del buttercream de merengue suizo, Clases de Zoom y Videos paso a paso: cómo hornear, rellenar, cubrir y alisar y tambien Receta y paso a paso del efecto drip o goteo.</p>
                <p>Por el modico precio de: $5300</p>
