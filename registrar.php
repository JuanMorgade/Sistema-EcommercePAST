...
<header class="row header--sticky">
    ...
    <section class="row">
            <div class="col-12 mt-5">
                <br><br>
                <h2 class="subtitulo mt-5 text-center">Registro De Sesión</h2>
                <br><br>
            </div>
        </section>
        ...
        <form action="servicios/register.php" method="POST" class="form_login">
				...
				<input type="text" name="emausur" placeholder="Correo Electrónico">
				<input type="password" name="pasusur" placeholder="Contraseña">
                <input type="password" name="pasusur2" placeholder="Confirme Contraseña">
