    ...
    <article>
        <section class="row">
            <div class="col-12 mt-5">
                <br><br>
                <h2 class="subtitulo mt-5 text-center">Usted Compro cursos</h2>
                <br><br>
                <section class="main_content">
                    <div class="compra_curso_c">
                        <h2>Gracias Por Comprar En Nuestra Página</h2>
                        <h3>Para terminar la compra pulse el botón, a la brevedad recibirá un Mail en su correo electronico con todos los archivos para poder comenzar el curso.</h3>
                    <button onclick="comprar()" class="boton_finalizar">Finalizar Con La Compra</button>
                    </div>
                </section>
        ...
        <script type="text/javascript">
            function comprar(){
                ...
                $.ajax({
                    url:'servicios/pedidos/confir2.php',
                    type:'POST',
                    data:{
                        telusu:31117177
                    },
