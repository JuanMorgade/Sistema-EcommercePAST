    ...
    <article>
        <section class="row">
            <div class="col-12 mt-5">
                <br><br>
                <h2 class="subtitulo mt-5 text-center">Error En Su Compra</h2>
                <br><br>
                <section class="main_content">
                    <div class="compra_curso_c">
                        <h2>Ha ocurrido un error en la compra de su curso</h2>
                        <h3>Intente nuevamente, o pulse el botón para regresar al inicio</h3>
                        <button onclick="inicio()" class="boton_finalizar">Regresar Al Inicio</button>
                    </div>
                </section>
